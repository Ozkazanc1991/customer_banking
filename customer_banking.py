...
def main():
    ...
    savings_interest = float(input("Enter your interest rate for your savings account: "))
    savings_maturity = int(input("Enter the length of the months for the savings account: "))
